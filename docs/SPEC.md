...
- **Amorçage du profil non résolu.** Tout dépend de la date anniversaire et de la situation, qu'un nouvel utilisateur connaît mal (et un profil *première admission* n'a ni anniversaire ni cycle). L'onboarding doit gérer « je ne sais pas », et le moteur ne doit jamais produire de division par zéro ni de faux « bloqué » à 0 heure.
