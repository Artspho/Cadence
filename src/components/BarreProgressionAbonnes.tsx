...
export function BarreProgressionAbonnes() {
  ...
  return (
    <div className="flex justify-end">
      <div className="bg-surface border border-line rounded-card p-3.5 w-full sm:w-auto sm:min-w-[280px] sm:max-w-xs">
        <div className="flex items-center justify-between gap-3 flex-wrap mb-1.5">
          <p className="text-xs font-medium text-ink">Vers une baisse du prix de l'abonnement</p>
          <span className="text-xs font-medium tabular-nums text-mint">
